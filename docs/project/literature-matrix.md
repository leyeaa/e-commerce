...
Crossref metadata was rechecked on 2026-07-16. In particular, the Sartaj et al.
record is now published in 2026 in volume 35, issue 6, pages 1-46; earlier draft
metadata had treated it as a 2025 early record. Final document export must still
be checked for the instructor's preferred IEEE punctuation and typography.
